...
description: Configure scoped private skills so the AI Rules CLI pulls them with public ones, and publish a local skill privately. Use for wiring AI_RULES_SECRET + scope, sharing team/client skills, or diagnosing missing private skills.
---

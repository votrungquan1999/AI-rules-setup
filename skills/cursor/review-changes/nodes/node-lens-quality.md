...
2. **Standards compliance**
   - Follows project conventions (check the project rules in `.cursor/rules/*.mdc` that apply to the directories the diff touches — cite the specific rule when flagging)

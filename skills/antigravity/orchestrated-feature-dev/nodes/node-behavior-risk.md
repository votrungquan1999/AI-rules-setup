...
- Read the `implementation-plan.md` artifact — the requirement change and its intended behaviors.
...
Write the catalog to the `behavior-risks.md` artifact. It is **frozen** once written — do not revise it in any later phase.

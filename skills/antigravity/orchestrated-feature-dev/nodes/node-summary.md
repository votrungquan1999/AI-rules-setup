...
[Under `per-behavior`: each commit subject against its behavior, and whether the counts match. Under `defer`: "no commits made — changes are in the working tree for you to commit."]
